...
import { Truck, Search, History, CheckCircle } from 'lucide-react';
...
export default function DistributorDashboard() {
  ...
  const tabs = [
    { id: 'record', label: 'Record Logistics', icon: Truck },
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
              <h2 className="text-base font-bold text-gray-900 mb-4 flex items-center gap-2">
                <Search className="w-4 h-4 text-indigo-600" /> Find Product to Ship or Receive
              </h2>
            ...
            {selected && !done && (
              <div className="bg-white rounded-2xl border border-indigo-100 shadow-sm p-6">
                <h2 className="text-base font-bold text-gray-900 mb-4 flex items-center gap-2">
                  <Truck className="w-4 h-4 text-indigo-600" /> Record Logistics Event
                </h2>
                <RecordEventPanel
                  product={selected}
        ...
        {tab === 'history' && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <h2 className="text-base font-bold text-gray-900 mb-4">My Logistics Events ({history.length})</h2>
            {loading ? (
